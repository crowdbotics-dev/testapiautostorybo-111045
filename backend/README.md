...
## Project Structure
    ...
    ├── testapiautostorybo_111045  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_111045`
...
2. Clone this repo and `cd testapiautostorybo_111045`
